...
namespace MySkin_Alpha
{
    ...
    public sealed partial class ImagePage : Page
    {
        ...
        private async Task<WriteableBitmap> process(byte[] pixelData)
        {
            ...
            edgeGen = processor.Edge(gray, Mask.Gaussian3x3, factorSlider.Value, Convert.ToInt32(biasSlider.Value));
            edgeLoc = processor.Edge(gray, Mask.Gaussian5x5Type2, factorSlider.Value, Convert.ToInt32(biasSlider.Value));
